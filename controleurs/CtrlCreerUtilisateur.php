...
// Ecrit le 12/10/2015 par Nicodeo
	...
	if ($nom == ''||$mail == '') {
		...
		if ( !$dao->existeUtilisateur($nom))  {
			...
			$outil->envoyerMail($mail, "Vous êtes membre de M2L!", "Vous avez été ajouté au site avec le pseudo : ".$nom. " et avec le mot de passe : ".$mdp, "delasalle.sio.deoliveira.n@gmail.com");
			$themeFooter = $themeNormal;
			include_once ('vues/VueCreerUtilisateur.php');
		}
		else {
