			...
			<div data-role="content">
				...
				<form name="form1" id="form1" action="index.php?action=SupprimerUtilisateur" method="post">
					...
					<div data-role="fieldcontain" class="ui-hide-label">
						<input type="text" name="nom" id="nom" placeholder="Entrez le nom de l'utilisateur" value="" >
					</div>

					<div data-role="fieldcontain">
						<input type="submit" name="supprimer" id="supprimer" value="Supprimer l'utilisateur">
					</div>
				</form>
			</div>
